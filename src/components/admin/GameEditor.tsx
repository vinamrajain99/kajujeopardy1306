        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <input
              ...
              className="bg-transparent border-none font-display text-2xl text-gold focus:outline-none focus:ring-0"
            />
          </div>
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="grid lg:grid-cols-[300px_1fr] gap-6">
          ...
          <div className="glass rounded-xl p-4 h-fit">
            <h3 className="font-display text-xl text-gold mb-4">Categories</h3>
                  ...
                  {selectedCategory === catIndex && (
                    <div className="ml-4 mt-2 space-y-1">
                      {category.questions.map((q, qIndex) => (
                        ...
                        >
                          ${q.points} - {q.text ? q.text.slice(0, 20) + "..." : "Empty"}
                        </button>
                      ))}
                    </div>
                  )}
          ...
          <div className="glass rounded-xl p-6">
            ...
            <h3 className="font-display text-xl text-gold mb-4">
              Question (${currentQuestion?.points})
            </h3>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-32 bg-input border border-border rounded-lg px-4 py-3 text-foreground focus:ring-2 focus:ring-gold focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-input border border-border rounded-lg px-4 py-3 text-foreground focus:ring-2 focus:ring-gold focus:border-transparent resize-none"
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="w-5 h-5 rounded border-border bg-input text-gold focus:ring-gold"
                />
                ...
                <div className="space-y-4">
                  ...
                  {currentQuestion.options.map((option, index) => (
                    <div key={option.id} className="flex items-start gap-3">
                      <div className="w-8 h-8 rounded-full bg-secondary flex items-center justify-center font-display text-sm shrink-0 mt-2">
                      ...
                      <div className="flex-1 space-y-2">
                        <input
                          ...
                          className="w-full bg-input border border-border rounded-lg px-4 py-2 text-foreground focus:ring-2 focus:ring-gold focus:border-transparent"
                        ...
                        <input
                          ...
                          className="w-full bg-input border border-border rounded-lg px-4 py-2 text-foreground text-sm focus:ring-2 focus:ring-gold focus:border-transparent"
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        <input
                          ...
                          onChange={() => updateQuestion({ correctAnswerIndex: index })}
